...
const PageTwo = () => {
    ...
    return (
        <div className='min-h-screen bg-black flex flex-col  justify-between'>
            ...
            {/* **************Mobile screen */}
            <nav className='flex items-center justify-between py-3 ml-5 mr-5  lg:hidden'>
            ...
            <section className='flex flex-col-reverse lg:flex-row justify-between '>
                <div className='ml-5 mr-5 py-5 lg:ml-5 lg:mr-5 lg:py-5 2xl:ml-10 2xl:mr-10 2xl:py-10 space-y-5 2xl:space-y-14 -mt-2 xl:mt-0 2xl:-mt-36 3xl:-mt-80'>
                    <div className='hidden sm:block'>
                        <p className=' text-[14px] 2xl:text-[20px] text-[#ffff] opacity-50 tracking-[1.5px]'>more information</p>
                    </div>
                    <div className='hidden sm:block'>
                    ...
                    <div className='flex  justify-start  '>
                        <div className='flex items-center space-x-10 tracking-[1.5px] leading-[17px] sm:leading-normal 3xl:leading-[30px]'>
                ...
                <div className='flex flex-col items-center sm:items-end ml-5 mr-5  lg:ml-5 lg:mr-5 text-white  2xl:ml-10 2xl:mr-10 3xl:-mt-36 '>
                    <div className='flex flex-col items-center sm:items-end -space-y-10'>
                        <div className='flex flex-col sm:flex-row items-center space-x-3'>
                            <p className='text-[70px] lg:text-[150px] 2xl:text-[180px]'>175.53</p>
                            <div className='sm:hidden'><p className='text-[10px] xl:text-[16px] -mt-3 lg:mt-0'>DOWNLOAD</p></div>
                            ...
                            <div className='flex items-center sm:block text-[25px] xl:text-[16px]  2xl:text-[20px] space-x-2 sm:space-x-0 sm:space-y-2 lg:space-y-5'>
                                <button onClick={'testHandler'} className='block sm:hidden cursor-pointer '>
                                    <img src="/assets/ZIFI-Arrow-Green.svg" className=' w-[20px] lg:w-[43px] ' alt="" />
                                </button>
                                <p>Mbps</p>
                                <button onClick={'testHandler'} className='hidden sm:block cursor-pointer '>
                                    <img src="/assets/ZIFI-Arrow-Green.svg" className=' w-[23px] lg:w-[43px] ' alt="" />
                                </button>
                            </div>

                        </div>
                        <div className='hidden sm:block'><p className='text-[10px] xl:text-[16px] mt-5 lg:mt-0'>DOWNLOAD</p></div>
                    </div>

                    <div className='flex flex-col items-center sm:items-end -space-y-10 '>
                        <div className='flex flex-col sm:flex-row items-center space-x-3'>
                            <p className='text-[70px] lg:text-[150px] 2xl:text-[180px]'>52.92</p>
                            <div className='sm:hidden'><p className='text-[10px] xl:text-[16px] -mt-3 lg:mt-0'>UPLOAD</p></div>

                            <div className='flex items-center sm:block text-[25px] xl:text-[16px]  2xl:text-[20px] space-x-2 sm:space-x-0 sm:space-y-2 lg:space-y-5'>
                                <button onClick={'testHandler'} className='block sm:hidden cursor-pointer '>
                                    <img src="/assets/ZIFI-Upload-Arrow-Purple.svg" className=' w-[20px] lg:w-[43px] ' alt="" />
                                </button>
                                <p>Mbps</p>
                                <button onClick={'testHandler'} className='hidden sm:block cursor-pointer '>
                                    <img src="/assets/ZIFI-Upload-Arrow-Purple.svg" className=' w-[23px] lg:w-[43px] ' alt="" />
                                </button>
                            </div>

                        </div>
                        <div className='hidden sm:block'><p className='text-[10px] xl:text-[16px] mt-5 lg:mt-0'>UPLOAD</p></div>
                    </div>
                </div>
